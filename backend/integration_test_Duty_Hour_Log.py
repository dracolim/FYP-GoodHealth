...
import pytest
import json
from app import app, db, Personal_Details, Duty_Hour_Log
...
class TestDutyHourLog(TestApp):
    ...
    def test_read_all_duty_hour_log(self):
      ...
      "Submitted_Proportion": "0.5"
        ...
        response = self.client.get("/duty_hour_log")
        self.assertEqual(response.status_code, 200)
